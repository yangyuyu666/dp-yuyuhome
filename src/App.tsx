...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-serif selection:bg-rose-200 selection:text-rose-900">
      <nav className="fixed top-0 z-50 w-full border-b border-rose-100 bg-white/85 backdrop-blur-md">
        <div className="mx-auto flex min-h-16 max-w-6xl flex-col gap-3 px-4 py-3 md:h-16 md:flex-row md:items-center md:justify-between md:py-0">
          <div className="text-xl font-handwriting text-rose-600 flex items-center gap-2">
            <Heart className="w-5 h-5 fill-rose-500 text-rose-500" />
            D & Y
          </div>
          <div className="flex gap-5 overflow-x-auto whitespace-nowrap pb-1 text-sm font-medium text-stone-600 md:gap-8 md:overflow-visible md:pb-0">
      ...
      <section
        id="home"
        className="relative flex min-h-[82svh] items-center justify-center overflow-hidden px-4 pb-16 pt-36 sm:pt-40 md:min-h-[80vh] md:pb-32 md:pt-48"
      >
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          >
            <h1 className="mb-5 text-4xl font-handwriting tracking-wide text-rose-600 sm:text-5xl md:mb-6 md:text-7xl md:tracking-wider">
              戴鹏和杨雯寓的小屋
            </h1>
            <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-stone-600 sm:text-lg md:mb-12 md:text-xl">
              把一起生活的痕迹都留在这里。
              <br />
              合照、桶桶、蛋蛋，慢慢把小屋填满。
            </p>
          ...
          <motion.div
            ...
            className="inline-flex w-full max-w-sm flex-col items-center justify-center rounded-3xl border border-rose-50 bg-white/60 p-6 shadow-xl shadow-rose-100/50 backdrop-blur-sm sm:w-auto sm:p-8"
          >
            <div className="mb-2 flex items-center gap-3 text-rose-500 sm:gap-4">
              <CalendarDays className="h-5 w-5 sm:h-6 sm:w-6" />
              <span className="font-sans text-xs font-semibold uppercase tracking-widest sm:text-sm">
                我们相爱的第
              </span>
            </div>
            <div className="my-3 font-sans text-5xl font-bold text-rose-600 sm:text-6xl md:my-4 md:text-7xl">
      ...
      <section id="story" className="bg-white py-14 md:py-20">
          ...
          <div className="space-y-6 md:space-y-12">
            {[
              ...
              <motion.div
                ...
                className="flex flex-col items-start gap-4 rounded-3xl border border-rose-50 bg-rose-50/30 p-5 md:flex-row md:items-center md:gap-6 md:p-8"
              >
      ...
      <section id="gallery" className="bg-rose-50/30 py-14 md:py-20">
          ...
          <div className="space-y-8 md:space-y-14">
            {photoGroups.map((group, groupIndex) => (
              <motion.section
                ...
                className="rounded-3xl border border-rose-100 bg-white/80 p-4 shadow-sm sm:p-6 md:p-8"
              >
      ...
      <section id="messages" className="bg-white py-14 md:py-20">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="relative rounded-3xl border border-rose-100 bg-rose-50/50 p-5 sm:p-8 md:p-12">
            <div className="absolute top-4 left-4 text-rose-200">
              <svg width="40" height="40" viewBox="0 0 24 24" fill="currentColor">
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
              </svg>
            </div>
            <p className="relative z-10 text-base leading-loose text-stone-700 sm:text-lg md:text-xl">
              以后我们还会继续拍很多照片，
              <br />
              把日常、旅行、桶桶和蛋蛋都慢慢存进来，
              <br />
      ...
      <footer className="bg-rose-100/50 px-4 py-10 text-center md:py-12">
